...
def run_function(inFunction, inValue):
	...
	print "beginning of run_function"
	print inFunction
	setOfFunctions = {
	'wait': wait(inValue),
	'click': click(inValue),
...
tests_dir = "C:\Users\\f002nx3\Google Drive\Lab Computers App Installation\Work Environment\Actualtest.sikuli\\application_tests"
#find each testfile.csv and execute 
print "Program has begun executing"
for test_folder in os.listdir(tests_dir):	
	print "Now in test folder loop"
	test_file = test_folder + ".csv"
	print "test_file: " + test_file
	test_dir = tests_dir + "\\" + test_folder
	print "test_dir: " + test_dir
	test_file = test_dir + "\\" + test_file
	print "test_file2: " + test_file
